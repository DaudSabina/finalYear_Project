                ...
                <div class="col-md-3 ">
                  <div class="card bg-success border-success">
                    ...
                    <div class="card-body fw-bold" style="text-align: center;">
                      <span>
                        <?php
                        $queryapproved = "select * from waste_request where request_status_id = 2";
                ...
                <div class="col-md-3 ">
                  <div class="card bg-info border-info">
                    ...
                    <div class="card-body fw-bold" style="text-align: center;">
                      <span>
                        <?php
                        $queryCollected = "select * from waste_request where request_status_id = 3";
                        $send3 = mysqli_query($con, $queryCollected);
                        $Collected = mysqli_num_rows($send3);
