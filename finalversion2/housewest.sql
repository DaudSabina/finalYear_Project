...
CREATE TABLE IF NOT EXISTS `complaints` (
  ...
  `complaint` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
(13, 'collector waste', 'wastecollector@gmail.com', 'sijakuta mtu mimi nimeondoka ');
...
(39, 'Admin', 'Admin', 'admin@gmail.com', '$2y$10$Kxxkj1/GQa/bidwfusVyWeQCTItTFagqQ0GyDVMsAeuQWIt5U7kQC', 4, '1234567890', 4, 4),
(40, 'Officer', 'Officer', 'officer@gmail.com', '$2y$10$hzFyH4LBSzcvijdpQlA1V.EPvkpt.pKqDR1r5kJ6xlEGnEj4jC8l6', 3, '1234567890', 4, 3),
(41, 'waste', 'collector', 'wastecollector@gmail.com', '$2y$10$80AvdVSPk6iH/n6/9Cfjc.mQ8El6rtZFLChReRdBspLw9fKY.gZuq', 3, '1234567890', 4, 2),
(42, 'waste', 'generator', 'wastegenerator@gmail.com', '$2y$10$V4hYxONAU2xOIfiAx42XuO69QanuaLepxM7a5sC6SmNJbW2Q0O99W', 3, '1234567890', 4, 1);
...
CREATE TABLE IF NOT EXISTS `waste_request` (
  ...
  `waste_colletor_id` int DEFAULT '0',
  PRIMARY KEY (`id`),
...
(4, 'house houlder', 1, 42, 3, 0, 28),
(5, 'house houlder', 1, 42, 3, 0, 41),
(6, 'house houlder', 1, 42, 3, 0, 41),
(14, 'nyumba', 1, 42, 1, 1, 41),
(24, 'nyumban', 1, 42, 3, 1, 41),
(25, 'nyumban2', 2, 42, 2, 1, 41);
