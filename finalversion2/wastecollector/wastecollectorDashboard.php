                  ...
                  <div class="card bg-primary border-primary">
                    ...
                    <div class="card-body fw-bold" style="text-align: center;">
                      <span>
                        <?php
                        // echo $user_id;
                        $queryallrequest = "select * from waste_request where waste_colletor_id = $user_id ";
                ...
                <div class="col-md-3 ">
                  <div class="card bg-warning border-warning">
                    ...
                    <div class="card-body fw-bold" style="text-align: center;">
                      <span>
                        <?php
                        $querypendding = "select * from waste_request where request_status_id = 1 and  waste_colletor_id = $user_id";
                ...
                <div class="col-md-3 ">
                  <div class="card bg-success border-success">
                    ...
                    <div class="card-body fw-bold" style="text-align: center;">
                      <span>
                        <?php
                        $querypendding = "select * from waste_request where request_status_id = 2 and  waste_colletor_id = $user_id";
                        $send = mysqli_query($con, $querypendding);
                        $pendding = mysqli_num_rows($send);
                ...
                <div class="col-md-3 ">
                  <div class="card bg-info border-info">
                    ...
                    <div class="card-body fw-bold" style="text-align: center;">
                      <span>
                        <?php
                        $querypendding = "select * from waste_request where request_status_id = 3 and  waste_colletor_id = $user_id";
                        $send = mysqli_query($con, $querypendding);
                        $pendding = mysqli_num_rows($send);
