...
<body>
	...
	<main id="main" class="main">
		...
		<div class="pagetitle">
			<h1>waste colletor | List of Waste request </h1>
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<table class="table datatable table-responsive">
											...
											$select = "SELECT * FROM waste_request where waste_colletor_id = $user_id";
											...
											?>
												<thead>
													<tr class="bg-light text-dark">
														...
														<th class="col">Waste generetor</th>
												...
												<tbody>
													...
													?>
														...
														<tr id="<?php echo $waste['id']; ?>" class="id" style="text-align: ;">
															...
															<td class="col"><?php echo $waste_waste_generator_fname . " " . $waste_waste_generator_lname; ?></td>
                                            ...
                                            ?>
																...
																<!-- <span class="col"><a href="./update_waste.php?update=<?php echo $waste['id']; ?>" name="update"><i class="fs-4  bi-pencil-square text-warning fw-bold"></i></a> -->
																</span>
															</td>
															<td class="col" colspan="2" href="#" name="update">



																<span class="col"><a href="./assign_collector.php?update_request=<?php echo $waste['id']; ?>" name="update"><i class="fs-4  bi-pencil-square text-warning fw-bold"></i></a>
																</span>
															</td>
