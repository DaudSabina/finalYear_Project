...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>waste collector | Waste request management</h1>
                    ...
                    <div class="card">
                        <div class="card-body pt-3">
                            ...
                            <ul class="nav nav-tabs nav-tabs-bordered">
                                ...
                                <li class="nav-item">
                                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">Update Waste Request </button>
                                </li>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <select name="request_status" id="yourwaste_category" class="form-control form-select">
                                                    ...
                                                    $select_waste_request = "select * from status where id =3";
