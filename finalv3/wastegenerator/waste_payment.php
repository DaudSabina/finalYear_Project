...
<body>
	...
	<main id="main" class="main">
		...
		<div class="pagetitle">
			<h1>Waste generator | List of Waste payments </h1>
           ...
           $result = mysqli_query($con, $select_payment);
              ...
              <th class="col">Approved Date</th>
												...
												<tbody>
													...
													$sn = 1;
													while ($waste_payment = mysqli_fetch_assoc($result)) {
                ...
                $waste_request_id  = $waste_payment['waste_request_id'];
                $Amount = $waste_payment['Amount'];
                $bill_number = $waste_payment['bill_number'];
                $payment_status = $waste_payment['payment_status'];
                $payment_date = $waste_payment['payment_date'];
                $payment_update = $waste_payment['payment_update'];
                $receipt = $waste_payment['receipt'];

											

              $select1 = "SELECT * FROM waste_request where id =$waste_request_id";
              $result1 = mysqli_query($con, $select1);
              $waste = mysqli_fetch_assoc($result1);
              ...
              $waste_name = $waste['waste_name'];
               ...
               <td class="col"><?php echo  $Amount;  ?></td>
               <td class="col"><?php echo  $bill_number;  ?></td>
															...
															<td class="col" colspan="2" name="update">
																...
																<?php } elseif ($payment_status == 6) { ?>

																	<span class="badge m-1 bg-success remove">Paid</span>

																<?php  }else{?>
																	<span class="badge m-1 bg-danger remove">Not Paid</span>
															...
															<td class="col">
															<?php echo  $receipt ?>	<a href="../receipt/<?php echo  $receipt ?>"><i class="bi bi-file-pdf text-primary fw-bold ">Preview</i> </a>
														</td>
               <td class="col"><?php echo  $payment_date ?></td>

               <td class="col"><?php echo  $payment_update   ?></td>
