...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div>
      ...
      if (isset($_SESSION['request_not_success'])) { ?>
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
        <?php

        echo $_SESSION['request_not_success'];

        unset($_SESSION['request_not_success']);
      }
...
<!-- End Dashboard Nav -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Waste Generetor | Dashboard</h1>
      <!-- <nav>
        <ol class="breadcrumb">
                ...
                <div class="col-md-3 ">
                  <div class="card bg-primary border-primary">
                    ...
                    <div class="card-body fw-bold" style="text-align: center;">
                      <span>
                        <?php
                        $queryallrequest = "select * from waste_request where	waste_generetor_id =$user_id ";
                ...
                <div class="col-md-3 ">
                  <div class="card bg-warning border-warning">
                    ...
                    <div class="card-body fw-bold" style="text-align: center;">
                      <span>
                        <?php
                        $querypendding = "select * from waste_request where request_status_id = 1 and 	waste_generetor_id =$user_id";
                ...
                <div class="col-md-3 ">
                  <div class="card bg-success border-success">
                    ...
                    <div class="card-body fw-bold" style="text-align: center;">
                      <span>
                        <?php
                        $queryapproved = "select * from waste_request where request_status_id = 2 and 	waste_generetor_id =$user_id";
                        $send1 = mysqli_query($con, $queryapproved);
                        $approved = mysqli_num_rows($send1);
                ...
                <div class="col-md-3 ">
                  <div class="card bg-info border-info">
                    ...
                    <div class="card-body fw-bold" style="text-align: center;">
                      <span>
                        <?php
                        $queryCollected = "select * from waste_request where request_status_id = 2 and 	waste_generetor_id =$user_id";
                        $send3 = mysqli_query($con, $queryCollected);
                        $all = mysqli_num_rows($send3);
              ...
              <div class="row ">
                ...
                <div class="col-md-3 ">
                  <div class="card bg-danger border-danger">
                    ...
                    <span>
                        <?php
                        $queryPayment2 = "select * from waste_request wherepayment_status_id = 7";
