...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Officer | List of Waste complaints </h1>
                                            ...
                                            ?>
                                                <thead>
                                                    <tr class="bg-light text-dark">
                                                        ...
                                                        <th class=" col" colspan="">Complaint name</th>
                                                        <th class="col">Email</th>

                                                        <th class="col">Complaints</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($waste = mysqli_fetch_assoc($result)) {
                                                        $waste_name = $waste['fname'];
                                                        $email = $waste['email'];
                                                        $complaint = $waste['complaint'];
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr id="<?php echo $waste['id']; ?>" class="id" style="text-align: ;">
                                                            ...
                                                            <td class="col"><?php echo $complaint; ?></td>
