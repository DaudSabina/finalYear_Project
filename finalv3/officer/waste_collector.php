...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div>
            ...
            if (isset($_SESSION['create_waste_collector'])) { ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                <?php

                echo $_SESSION['create_waste_collector'];

                unset($_SESSION['create_waste_collector']);
            }
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Officer | List of waste collector </h1>

            <a href="./add_waste_collector.php">

                <button type="submit " class="btn btn-primary sm float-right bi bi-person-plus mt-3" href="status.php"> Add waste collector</button>
            </a>
