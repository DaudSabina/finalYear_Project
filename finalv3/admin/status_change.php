											...
											?>
												...
												<tbody>
													...
													?>
															...
															<td class="col" colspan="2" href="#" name="update">
																...
																if ($status == 4) { ?>
																	<a href="#">
																		...
																		<button class="badge m-1 bg-success remove">Active</button>


																	<?php } elseif ($user['status'] == 5) { ?>
																		<a href="#">
																			<button class="badge m-1 bg-danger remove">
																				In Ative</button>

																		<?php  }
																		?>
																		</a>
																		<span class="col"><a href="./update_user.php?update=<?php echo $user['user_id']; ?>" name="update"><i class="fs-4  bi-pencil-square text-warning fw-bold"></i></a>
																		</span>
															</td>
														...
														<!-- <td class="col"><a href="../updates/update_user.php?update=<?php echo $user['user_id']; ?>" name="update"><i class="fs-4  bi-pencil-square text-warning fw-bold"></i></a></td> -->
